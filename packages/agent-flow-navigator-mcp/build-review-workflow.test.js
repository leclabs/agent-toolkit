...
describe("build-review-murder-board diagram generation", () => {
  ...
  it("should include gate nodes as diamonds in the diagram", () => {
    ...
    assert.ok(diagram.includes('review{"Murder Board Review<br/><small>👀 Reviewer ↻3</small>"}'));
...
describe("build-review-quick diagram generation", () => {
  ...
  it("should include gate nodes as diamonds in the diagram", () => {
    ...
    assert.ok(diagram.includes('review{"Quick Review<br/><small>👀 Reviewer ↻2</small>"}'));
    assert.ok(diagram.includes('lint_format{"Lint and Format<br/><small>🔧 Developer ↻3</small>"}'));
  });
